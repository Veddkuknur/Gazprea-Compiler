#ifndef SCOPETOFREEWALKER_H
#define SCOPETOFREEWALKER_H

#include "BaseASTWalker.h"
#include "Symbol.h"
#include "ScopedSymbol.h"

class ScopeToFreeWalker : public BaseASTWalker {
public:

    bool in_nested_scope = false;
    bool in_main_procedure = false;
    std::shared_ptr<Scope> global_scope;
    std::shared_ptr<Scope> func_proc_scope;
    std::stack<std::shared_ptr<Scope>> loop_scope_stack;
