...
#ifndef GAZPREABASE_CALLFUNCCALLERRORWALKER_H
#define GAZPREABASE_CALLFUNCCALLERRORWALKER_H

#include "BaseASTWalker.h"
#include <vector>

class CallFuncCallErrorWalker : public BaseASTWalker {
public:
    ~CallFuncCallErrorWalker() override = default;

    std::map<std::string, bool> functionNames;
    bool in_func = false;
    int procCountInExpr = 0;
...
#endif //GAZPREABASE_CALLFUNCCALLERRORWALKER_H
