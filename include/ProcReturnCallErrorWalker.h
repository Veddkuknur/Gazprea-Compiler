#ifndef GAZPREABASE_PROCRETURNCALLERRORWALKER_H
#define GAZPREABASE_PROCRETURNCALLERRORWALKER_H

#include "BaseASTWalker.h"

class ProcReturnCallErrorWalker : public BaseASTWalker {
public:
    ~ProcReturnCallErrorWalker() override = default;

    std::map<std::string, bool> procReturns; // map to track whether a procedure return something or not
...
#endif //GAZPREABASE_PROCRETURNCALLERRORWALKER_H
