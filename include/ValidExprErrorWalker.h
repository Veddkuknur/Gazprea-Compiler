#ifndef GAZPREABASE_VALIDEXPRERRORWALKER_H
#define GAZPREABASE_VALIDEXPRERRORWALKER_H

#include "BaseASTWalker.h"

class ValidExprErrorWalker: public BaseASTWalker {
public:
    ~ValidExprErrorWalker() override = default;
...
#endif //GAZPREABASE_VALIDEXPRERRORWALKER_H
