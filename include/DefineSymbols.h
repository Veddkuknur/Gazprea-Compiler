#ifndef DEFOMESYMBOLS_H
#define DEFOMESYMBOLS_H
#include "BaseASTWalker.h"
#include "SymbolTable.h"
#include "Symbol.h"


class DefineSymbols: public BaseASTWalker {
public:

    std::shared_ptr<SymbolTable> symtab = nullptr; //Symbol table that contains all scopes in the program
    std::shared_ptr<VariableSymbol> domain_variable; // save iter loop's domain variable so it can be defined
                                                     //in the loop block scope
