#ifndef CONTROLFLOWERRORWALKER_H
#define CONTROLFLOWERRORWALKER_H

#include "BaseASTWalker.h"

class ControlFlowReturnErrorWalker : public BaseASTWalker {
public:
    ~ControlFlowReturnErrorWalker() override = default;
...
#endif //CONTROLFLOWERRORWALKER_H
