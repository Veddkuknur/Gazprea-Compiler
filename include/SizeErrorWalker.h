#ifndef SIZEERRORWALKER_H
#define SIZEERRORWALKER_H

#include "BaseASTWalker.h"


class SizeErrorWalker : public BaseASTWalker {
public:

    std::shared_ptr<Symbol> current_func_proc_symbol = nullptr;

    static bool isNonVecMatLiteral(const std::shared_ptr<ASTNode> &node);
