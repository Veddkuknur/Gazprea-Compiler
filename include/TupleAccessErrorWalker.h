#ifndef GAZPREABASE_TUPLEACCESSERRORWALKER_H
#define GAZPREABASE_TUPLEACCESSERRORWALKER_H

#include "BaseASTWalker.h"

class TupleAccessErrorWalker : public BaseASTWalker{
public:
    ~TupleAccessErrorWalker() override = default;
...
#endif //GAZPREABASE_TUPLEACCESSERRORWALKER_H
