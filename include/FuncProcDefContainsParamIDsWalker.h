#ifndef GAZPREABASE_FUNCPROCDEFCONTAINSPARAMIDSWALKER_H
#define GAZPREABASE_FUNCPROCDEFCONTAINSPARAMIDSWALKER_H

#include "BaseASTWalker.h"

class FuncProcDefContainsParamIDsWalker : public BaseASTWalker {
public:
  ~FuncProcDefContainsParamIDsWalker() override = default;
...
#endif //GAZPREABASE_FUNCPROCDEFCONTAINSPARAMIDSWALKER_H
