#ifndef GAZPREABASE_GLOBALSTATEMENTERRORWALKER_H
#define GAZPREABASE_GLOBALSTATEMENTERRORWALKER_H

// Checks if all the statements in the global scope are either function, procedure, typedef or decl

#include "BaseASTWalker.h"

class GlobalStatementErrorWalker : public BaseASTWalker {
public:
  ~GlobalStatementErrorWalker() override = default;

  bool is_global = true; // We start in the global scope
...
#endif //GAZPREABASE_GLOBALSTATEMENTERRORWALKER_H
