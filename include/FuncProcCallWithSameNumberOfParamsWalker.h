#ifndef GAZPREABASE_FUNCPROCCALLWITHSAMENUMBEROFPARAMSWALKER_H
#define GAZPREABASE_FUNCPROCCALLWITHSAMENUMBEROFPARAMSWALKER_H

#include "BaseASTWalker.h"

class FuncProcCallWithSameNumberOfParamsWalker : public BaseASTWalker {
public:
  ~FuncProcCallWithSameNumberOfParamsWalker() override = default;

    std::map<std::string, size_t> subroutines;
...
#endif //GAZPREABASE_FUNCPROCCALLWITHSAMENUMBEROFPARAMSWALKER_H
