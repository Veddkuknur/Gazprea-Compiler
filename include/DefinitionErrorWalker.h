#ifndef DEFINITIONERRORWALKER_H
#define DEFINITIONERRORWALKER_H
...
class DefinitionErrorWalker : public BaseASTWalker {
public:
    ...
    struct proc_func_info {
        ...
        bool is_func;
        int line;
        std::vector<bool> param_qualifiers; // procedures only
        std::shared_ptr<Type> return_type;
    };

    std::map<std::string, proc_func_info> proc_func_map;
