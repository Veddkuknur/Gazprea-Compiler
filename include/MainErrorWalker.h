#ifndef MAINERRORWALKER_H
#define MAINERRORWALKER_H

#include "BaseASTWalker.h"
#include <iostream>

// This walker ensures that a procedure called main exists in the global scope of the program
// and if it does exist, that the signature of main is valid.
class MainErrorWalker : public BaseASTWalker {
public:
    ~MainErrorWalker() override = default;
