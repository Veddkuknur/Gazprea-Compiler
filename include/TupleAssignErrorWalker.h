#ifndef GAZPREABASE_TUPLEASSIGNERRORWALKER_H
#define GAZPREABASE_TUPLEASSIGNERRORWALKER_H

#include "BaseASTWalker.h"

class TupleAssignErrorWalker : public BaseASTWalker {
public:
    ~TupleAssignErrorWalker() override = default;
...
#endif //GAZPREABASE_TUPLEASSIGNERRORWALKER_H
