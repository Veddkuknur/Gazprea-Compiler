...
#ifndef GAZPREABASE_RETURNERRORWALKER_H
#define GAZPREABASE_RETURNERRORWALKER_H

#include "BaseASTWalker.h"

class ReturnErrorWalker : public BaseASTWalker {
public:
    ~ReturnErrorWalker() override = default;
...
#endif //GAZPREABASE_RETURNERRORWALKER_H
