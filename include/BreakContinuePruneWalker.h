#ifndef BREAKCONTINUEPRUNEWALKER_H
#define BREAKCONTINUEPRUNEWALKER_H

#include "BaseASTWalker.h"

class BreakContinuePruneWalker : public BaseASTWalker {
public:
    ~BreakContinuePruneWalker() = default;
...
#endif //BREAKCONTINUEPRUNEWALKER_H
