#ifndef BASEASTWALKER_H
#define BASEASTWALKER_H

#include "ASTWalker.h"
#include "CompileTimeExceptions.h"

// derive your custom walkers from here so you don't have to override every method, only the necessary ones
class BaseASTWalker : public ASTWalker {
public:
    ~BaseASTWalker() = default;

    std::any visitRootNode(std::shared_ptr<RootNode> node) override { return {}; }
    ...
    std::any visitBlockNode(std::shared_ptr<BlockNode> node) override { return {}; }
