#ifndef GAZPREABASE_STDINOUTSTATEMENTERRORWALKER_H
#define GAZPREABASE_STDINOUTSTATEMENTERRORWALKER_H

#include "BaseASTWalker.h"

class StdInOutStatementErrorWalker : public BaseASTWalker {
public:
    ~StdInOutStatementErrorWalker() override = default;
...
#endif //GAZPREABASE_STDINOUTSTATEMENTERRORWALKER_H
